...
//	}
	...
	@GetMapping("/getbynamestartwith/{firstname}")
	public List<Employee> getEmpByNameStartingWith(String firstName) {
		LOG.info("getEmployeeBySalaryInBetween");
		return empService.getEmployeeByFirstNameStartingWith(firstName);
	}
