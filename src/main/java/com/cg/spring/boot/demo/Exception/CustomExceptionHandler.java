...
//		// code 
	...
	@ExceptionHandler(EmployeedAlreadyExit.class)
	public ResponseEntity<Object> handleEmployeedAlreadyExit() {
		LOG.error("handleEmployeedAlreadyExit");
		HttpHeaders headers = new HttpHeaders();
		headers.add("message", "This employee is already available in the database.");
		return new ResponseEntity<Object>(null, headers, HttpStatus.NOT_FOUND);
	}
